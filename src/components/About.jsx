...
const About = () => {
  const images = [
    { src: `${import.meta.env.BASE_URL}gsap.png`, alt: "Image 1" },
    { src: `${import.meta.env.BASE_URL}java.png`, alt: "Image 2" },
    { src: `${import.meta.env.BASE_URL}js.png`, alt: "Image 3" },
    { src: `${import.meta.env.BASE_URL}mongo.png`, alt: "Image 4" },
    { src: `${import.meta.env.BASE_URL}mysql.png`, alt: "Image 5" },
    { src: `${import.meta.env.BASE_URL}node.png`, alt: "Image 6" },
          ...
          <div className="flex flex-col lg:flex-row gap-5 mx-4 md:mx-10 mt-5 border-zinc-800">
            <div className="w-full lg:w-[40%] rounded-xl border-1 border-zinc-800">
              ...
              <p className="  p-2 text-2xl leading-7 tracking-normal text-center font-thin">
                ...
                course. Through this program, I’ve gained skills in SQL, HTML, CSS, JavaScript
                (ES6), ReactJS, Node.js, and MongoDB. I’m currently training in Java backend
